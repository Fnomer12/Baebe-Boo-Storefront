...
export default function MemberForm() {
  ...
  return (
    <form onSubmit={submit} className="grid gap-3 sm:grid-cols-2" aria-label="Join the Baebe Boo family">
      ...
      <label className="flex gap-3 py-2 text-xs leading-5 text-black/55 sm:col-span-2"><input required type="checkbox" className="mt-1 h-4 w-4" /> I agree to receive family updates and age-relevant offers. I can unsubscribe at any time.</label>
